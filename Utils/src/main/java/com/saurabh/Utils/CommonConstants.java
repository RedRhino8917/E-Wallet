...
public class CommonConstants {
    public static final String USER_CREATION_TOPIC = "NEW_USER_CREATED";

    public static final String TXN_INITIATED_TOPIC = "NEW_TXN_INITIATED";
    ...
    public static final String USER_CREATION_TOPIC_EMAIL = "USER_CREATION_TOPIC_EMAIL";
    public static final String USER_CREATION_TOPIC_PHONE_NO = "USER_CREATION_TOPIC_PHONE_NO";
    public static final String USER_CREATION_TOPIC_USERIDENTIFIER = "USER_CREATION_TOPIC_USERIDENTIFIER";
    public static final String USER_CREATION_TOPIC_USERIDENTIFIER_VALUE = "USER_CREATION_TOPIC_USERIDENTIFIER_VALUE";
